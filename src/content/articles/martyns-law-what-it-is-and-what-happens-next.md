...
That is genuinely new. Before this Act, no law required a shopping centre, a theatre, a nightclub or a festival to prepare for terrorism in any way. Fire safety has been compulsory for decades; counter-terrorism preparedness was a polite suggestion. The [Manchester Arena Inquiry](https://homeofficemedia.blog.gov.uk/2025/04/03/martyns-law-factsheet/) found exactly what that voluntary regime produced: security that was nobody's clear responsibility, staff who saw something and weren't sure what to do about it, and an attacker who waited in a CCTV blind spot for an hour.

Martyn's Law closes that gap with a duty that scales by size. It applies to premises across the UK where it is reasonable to expect **200 or more people** may be present at once — shops, bars, restaurants, theatres, sports grounds, hospitals, libraries, hotels, festivals — and it splits them into [two tiers](https://www.protectuk.police.uk/martyns-law/martyns-law-overview-and-what-you-need-know).

<figure>
  <img src="/images/martyns-law-tiers.svg" alt="Diagram comparing Martyn's Law standard tier (200–799 capacity) and enhanced tier (800+): the standard tier requires notifying the SIA and having evacuation, invacuation and lockdown procedures with a £10,000 maximum penalty; the enhanced tier adds protective measures and documented assessments with penalties up to £18m or 5% of revenue. Places of worship and schools stay standard tier regardless of size." loading="lazy" />
  <figcaption>Capacity decides the tier; the tier decides the duty. Everything is qualified by "so far as reasonably practicable".</figcaption>
</figure>

**The standard tier (200–799 people)** is deliberately cheap. Those responsible must [notify the new regulator and have public protection procedures in place](https://www.protectuk.police.uk/martyns-law/martyns-law-overview-and-what-you-need-know): how you would evacuate, how you would keep people *in* if outside is more dangerous ("invacuation"), how you would lock down, and how you would tell people on site what is happening. Staff need to know the plan. There is [no requirement for physical security measures at all](https://homeofficemedia.blog.gov.uk/2025/04/03/martyns-law-factsheet/) — no obligatory scanners, barriers or guards. The government's own [myth-buster](https://assets.publishing.service.gov.uk/media/69281f35b3b9afff34e960f0/martyns-law-mythbuster.pdf) is blunt that a village hall does not need a consultant, just a plan.

**The enhanced tier (800+ people, including big one-off events)** asks more, because the consequences of failure are bigger. On top of the procedures, those responsible must put in place [reasonably practicable *measures* — monitoring, physical security, security of information](https://www.protectuk.police.uk/martyns-law/martyns-law-overview-and-what-you-need-know) — and document how they have assessed and met the requirements, with a named senior person accountable.
...
<figure>
  <img src="/images/martyns-law-timeline.svg" alt="Timeline from the Manchester Arena attack on 22 May 2017, through Figen Murray's campaign, Royal Assent on 3 April 2025, statutory guidance and SIA consultation in spring 2026, to duties expected in force around spring 2027" loading="lazy" />
  <figcaption>Where Martyn's Law is on the road from campaign to commencement.</figcaption>
</figure>

The current state of play, as of June 2026:

- **The Act passed** on [3 April 2025](https://homeofficemedia.blog.gov.uk/2025/04/03/martyns-law-factsheet/).
- **The regulator is being built.** Enforcement goes not to the police but to a [new function inside the Security Industry Authority (SIA)](https://www.gov.uk/government/publications/martyns-law-the-sias-new-regulatory-role/martyns-law-the-sias-new-regulatory-role) — the body that already licenses door supervisors and security guards.
- **The official guidance has landed.** On 15 April 2026 the Home Office published the Act's [statutory guidance](https://www.nortonrosefulbright.com/en-gb/knowledge/publications/235fec0e/martyns-law), the document that tells duty-holders what compliance actually looks like, and the SIA opened a [public consultation on how it intends to regulate and enforce](https://www.gov.uk/government/news/sia-launches-consultation-on-section-12-guidance-for-martyns-law) — a consultation that closes on 12 June 2026.
...
If your capacity is under 200, the Act does not apply to you at all. If you are standard tier, your obligations amount to registering, thinking through four scenarios (out, in, lockdown, communicate), writing the answers down and making sure your staff know them. The Home Office's design intent — repeated across the [factsheet](https://homeofficemedia.blog.gov.uk/2025/04/03/martyns-law-factsheet/) and the [myth-buster](https://assets.publishing.service.gov.uk/media/69281f35b3b9afff34e960f0/martyns-law-mythbuster.pdf) — is that this should cost time, not money.

Enhanced-tier operators have real work: a documented assessment, protective measures justified as reasonably practicable, information security, and a senior accountable owner. The free, police-backed [ProtectUK platform](https://www.protectuk.police.uk/martyns-law) is the closest thing to an official preparation hub, and the sensible sequence for the next year is: confirm your tier, read the statutory guidance, assign ownership, write or refresh the procedures, train against them.

The incentive to take it seriously is also now concrete. The SIA will be able to issue compliance notices and, at the top end, [penalties of up to £10,000 in the standard tier and £18 million or 5% of worldwide revenue in the enhanced tier](https://www.osborneclarke.com/insights/martyns-law-introduces-new-security-measures-public-premises-and-events-uk), with daily penalties for continued non-compliance. Nobody expects the maximums to be routine — the SIA's own consultation emphasises advice first — but they exist, and they are not small.
...
First, **the advice burden lands locally before the regulator ever appears.** Counter Terrorism Security Advisers and the [ProtectUK](https://www.protectuk.police.uk/martyns-law) infrastructure sit on the policing side of the fence, and every neighbourhood team in the country polices premises that are about to acquire a legal duty they will have questions about. The officer who can say what the law actually requires — and, just as usefully, what it doesn't — will save businesses money and the service goodwill. The [neighbourhood policing](/police-policy/boosting-public-confidence-through-neighbourhood-policing) relationship is where most of those conversations will actually happen.

Second, **the quality of what police find on arrival should improve.** The operational promise of Martyn's Law is not that venues will stop attacks; it is that when the worst happens, the first officers through the door meet staff who have rehearsed an evacuation rather than improvised one. Every review of the Arena attack came back to those first minutes. A service that has spent years arguing prevention beats response — the argument running through this site's [evidence-based policing](/topics/evidence-based-policing) coverage — should recognise the logic.
...
One honest caveat before the lists: the law is real but **not yet in force**. The [statutory guidance has been published](https://www.gov.uk/government/news/martyns-law-guidance-published-to-help-businesses) and the regulator is being built, with the duties [expected to commence around spring 2027](https://www.protectuk.police.uk/martyns-law/martyns-law-overview-and-what-you-need-know). So everything below is a way to get ahead of the curve, not a list you can be penalised against today. Treat the checklists as an orientation aid — the final detail still depends on the regulator's guidance, which is [still being settled](https://www.wtwco.com/en-gb/insights/2026/05/martyns-law-statutory-guidance-update).
...
<figure>
  <img src="/images/martyns-law-cafe.jpg" alt="The interior of a busy independent café with customers at tables — the kind of standard-tier premises Martyn's Law is written around." loading="lazy" />
  <figcaption>The standard tier is built around places like this: the duty is to have a plan and a trained team, not to install scanners. Photo via <a href="https://www.pexels.com/photo/coffee-shop-interior-930402/">Pexels</a>.</figcaption>
</figure>
...
There is, in the standard tier, [no requirement to buy physical security](https://www.protectuk.police.uk/martyns-law/martyns-law-overview-and-what-you-need-know) — no obligatory scanners, barriers or guards. The duty is to think it through, write it down simply, and make sure your team knows the plan.
...
- **[ProtectUK](https://www.protectuk.police.uk/martyns-law)** — the official platform run by the Home Office, the National Counter Terrorism Security Office (NaCTSO) and Counter Terrorism Policing. Its [Martyn's Law hub and resources](https://www.protectuk.police.uk/martyns-law/resources) are the closest thing to a one-stop shop: guidance, templates, posters and a free mobile app.
- **The [statutory guidance on GOV.UK](https://www.gov.uk/government/news/martyns-law-guidance-published-to-help-businesses)** — the formal document setting out what compliance is intended to look like, and the [Home Office factsheet](https://homeofficemedia.blog.gov.uk/2025/04/03/martyns-law-factsheet/) for the plain-English version.
- **The [Security Industry Authority (SIA)](https://www.gov.uk/government/publications/martyns-law-the-sias-new-regulatory-role/martyns-law-the-sias-new-regulatory-role)** — the regulator. Enforcement goes to the SIA, *not* the police; no officer will be inspecting your invacuation plan. The SIA's stated posture is advice-first.
...
<figure>
  <img src="/images/martyns-law-staff-briefing.jpg" alt="A small team gathered around a table in a workplace briefing, one person leading the conversation." loading="lazy" />
  <figcaption>Most of the standard-tier duty is, in the end, a trained team who know the plan. A short staff briefing is the heart of it. Photo via <a href="https://www.pexels.com/photo/office-team-having-a-conversation-7640438/">Pexels</a>.</figcaption>
</figure>
...
- **SCaN — See, Check and Notify** — the [National Protective Security Authority's](https://www.npsa.gov.uk/) free training for customer-facing staff, security teams and managers, on noticing and acting on suspicious behaviour.
...
If you organise events, you will hear about **the Purple Guide**, and it is worth knowing exactly what it is so you neither ignore it nor over-rely on it. The Purple Guide — properly, *The Purple Guide to Health, Safety and Welfare at Music and Other Events* — is an industry guidance document maintained by the [Events Industry Forum](https://www.thepurpleguide.co.uk/index.php/welfare-handbook/martyn-s-law), a not-for-profit made up of events-industry bodies. It is a subscription-based online handbook, and it includes a [Counter Terrorism chapter](https://www.protectuk.police.uk/advice-and-guidance/awareness/purple-guide-counter-terrorism-chapter) developed with NaCTSO, plus a section addressing Martyn's Law directly.
...
<figure>
  <img src="/images/martyns-law-first-steps.svg" alt="Your first five steps under Martyn's Law: 1. Work out your capacity and tier. 2. Name who owns it — a responsible person. 3. Learn the four procedures: evacuate, invacuate, lock down, communicate. 4. Do the free ACT Awareness e-learning. 5. Write a simple plan down and rehearse it with staff. Marked provisional because the duties are not yet in force." loading="lazy" />
  <figcaption>If you do nothing else this year, do these five — in order.</figcaption>
</figure>

### What it might cost

For a standard-tier business, the honest answer is: mostly time. There is no mandatory spend on equipment, the official guidance and training are free, and the design intent — repeated across the [factsheet](https://homeofficemedia.blog.gov.uk/2025/04/03/martyns-law-factsheet/) and the government's myth-busting — is that a small venue should not need a consultant. Your costs are the hours to write a plan, train your staff and rehearse.
...
<figure>
  <img src="/images/martyns-law-event-crowd.jpg" alt="A large crowd at a night-time event with stage lighting — the kind of enhanced-tier gathering that attracts the fuller duty." loading="lazy" />
  <figcaption>The enhanced tier — big events like this — carries the heavier duty. Most businesses will never be in it. Photo via <a href="https://www.pexels.com/photo/people-gathering-on-concert-during-night-time-3727129/">Pexels</a>.</figcaption>
</figure>
...
**The threshold moved for a reason.** The original proposal captured premises from 100 capacity; after consultation and scrutiny — including warnings that village halls and community groups would drown — the floor [rose to 200](https://www.protectuk.police.uk/martyns-law/martyns-law-overview-and-what-you-need-know). That was probably right, and it was also a concession: the Act protects fewer places than Figen Murray campaigned for.
...
**And no law guarantees the counterfactual.** Nobody can say a duty like this would have stopped the Arena bomber. What the [Inquiry record](https://homeofficemedia.blog.gov.uk/2025/04/03/martyns-law-factsheet/) supports is narrower and still worth having: prepared venues spot more, respond faster, and save lives in the minutes before the first officer arrives. Figen Murray never claimed more than that. "I will feel Martyn walking beside me," she said, setting off on the walk that finished the job. The law that resulted is modest, practical and overdue — which may be exactly why it passed.

*Start with the free, official [ProtectUK Martyn's Law hub](https://www.protectuk.police.uk/martyns-law) — it is the single best place to turn the checklist above into a plan.*
...
- GOV.UK, [Martyn's Law guidance published to help businesses](https://www.gov.uk/government/news/martyns-law-guidance-published-to-help-businesses), [Martyn's Law: the SIA's new regulatory role](https://www.gov.uk/government/publications/martyns-law-the-sias-new-regulatory-role/martyns-law-the-sias-new-regulatory-role), and [SIA launches consultation on section 12 guidance](https://www.gov.uk/government/news/sia-launches-consultation-on-section-12-guidance-for-martyns-law), April 2026.
- The Purple Guide, [Martyn's Law](https://www.thepurpleguide.co.uk/index.php/welfare-handbook/martyn-s-law); and ProtectUK, [the Purple Guide Counter Terrorism chapter](https://www.protectuk.police.uk/advice-and-guidance/awareness/purple-guide-counter-terrorism-chapter).
- National Protective Security Authority, [NPSA](https://www.npsa.gov.uk/) — SCaN (See, Check and Notify) training.
- Norton Rose Fulbright, [Martyn's Law: statutory guidance, SIA consultation and key implications for duty holders](https://www.nortonrosefulbright.com/en-gb/knowledge/publications/235fec0e/martyns-law), 2026.
- Osborne Clarke, [Martyn's Law introduces new security measures for public premises and events in the UK](https://www.osborneclarke.com/insights/martyns-law-introduces-new-security-measures-public-premises-and-events-uk).
- WTW, [Martyn's Law: statutory guidance update](https://www.wtwco.com/en-gb/insights/2026/05/martyns-law-statutory-guidance-update), 2026.
- Counter Terror Business, [The campaign for Martyn's Law](https://counterterrorbusiness.com/features/campaign-martyns-law).
</output>
