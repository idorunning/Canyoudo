...
The turn came at Cambridge. In 2008 Murray completed a [Master's degree at the University's Institute of Criminology](https://www.bi.team/blogs/innovation-in-policing-a-guest-blog-from-chief-superintendent-alex-murray/), on the Police Executive Programme run by Professor Lawrence Sherman, the American criminologist who more or less invented the modern field of evidence-based policing. His thesis examined police legitimacy within Muslim communities, work he later developed into a peer-reviewed paper, [*Evidence-Based Policing of U.K. Muslim Communities*](https://journals.sagepub.com/doi/abs/10.1177/1057567715574384), co-authored with Katrin Mueller-Johnson and Sherman and published in the *International Criminal Justice Review* in 2015.

> "The basic premise of evidence-based practice is that we are all entitled to our own opinions, but not to our own facts."
> — Lawrence Sherman, [*Ideas in American Policing*, 1998](https://cebcp.org/evidence-based-policing/what-is-evidence-based-policing/)

Sherman's argument, which Murray absorbed and then carried back into operational policing, is deceptively simple. For decades policing had run on what Sherman called the "three Rs": random patrol, rapid response and reactive investigation. None of the three had much evidence behind it. Sherman proposed replacing them with what he later branded the "Triple-T" — targeting the small number of places, times and people that produce most harm; testing what works through controlled experiments; and tracking whether the effect holds. The intellectual framework was Sherman's. What British policing lacked was anyone to build the machinery that would put it into practice. Murray decided to be that person.

<figure>
  <img src="/images/triple-t-framework.svg" alt="Diagram of Sherman's Triple-T framework: Targeting, Testing and Tracking" loading="lazy" />
...
What can be said is narrower and more durable. Before 2010 there was no organised body in Britain through which a serving officer could find out what the research actually said, argue about it with peers, and take it back to the front line. After 2010 there was, and it spread across the English-speaking world and beyond. The College of Policing's What Works Centre for Crime Reduction, the growing use of harm-weighted targeting, the slow normalisation of trials and evaluation inside forces — none of these is solely Murray's doing, but all of them grew in soil he helped turn over. He built the place where the argument could happen, and then spent fifteen years making sure it kept happening.

That is the quieter kind of influence, and the more lasting. The detective who once asked who committed the crime ended up asking a harder question of his own profession, and refusing to let it look away from the answer.
...
- *Policing Insight*, ["Alex Murray: 'Our use of AI is not about government trying to make us do things — it's about protecting people'"](https://policinginsight.com/feature/interview/alex-murray-our-use-of-ai-is-not-about-government-trying-to-make-us-do-things-its-about-protecting-people/).
- Wikipedia, [Evidence-based policing](https://en.wikipedia.org/wiki/Evidence-based_policing) and [Lawrence W. Sherman](https://en.wikipedia.org/wiki/Lawrence_W._Sherman).
