...
tags:
  ...
  - jury
keyTakeaways:
  - Convincing fake video with synchronised audio can now be made cheaply from a single still, so a clip arriving as a file proves nothing until its origin is established.
  - 'Corroboration is just as easy to fabricate: a second "independent" camera angle is one more prompt, and several modest clips that agree can manufacture false certainty in a jury.'
  - The danger cuts both ways — a fake that is believed convicts the innocent, while a genuine clip dismissed as "probably AI" lets the guilty walk (the liar's dividend).
  - 'The defence is procedural, not a gadget: recover the native original, hash it at seizure, and treat provenance and chain of custody as the evidence.'
practicalSummary:
  problem: >-
    Convincing video with synchronised audio can now be faked cheaply from a
    single still, while genuine footage can be waved away as "probably AI" —
    and neither investigators nor the courts can yet reliably tell the
    difference.
  evidence:
    - point: >-
        A California court threw out a case in 2025 after finding the
        claimants had submitted deepfake video, admitting it lacked the time,
        funding and expertise to authenticate what it was handed.
      source: "Mendones v. Cushman & Wakefield (2025)"
      url: "https://reason.com/volokh/2025/09/25/court-throws-out-case-after-finding-plaintiffs-submitted-deepfake-videos-and-altered-images/"
    - point: >-
        Europol projected 8 million deepfakes in circulation in 2025, up from
        around 500,000 in 2023, and the Arup fraud took $25.6m in a single day
        on a deepfaked video call.
    ...
    - point: >-
        England and Wales still presumes a computer was working correctly —
        the presumption behind the Post Office Horizon convictions — and
        reform only reached a call for evidence in January 2025.
      source: "Ministry of Justice call for evidence (2025)"
      url: "https://www.computerweekly.com/news/366614104/Change-to-rules-on-computer-evidence-will-be-an-outcome-of-Post-Office-scandal"
  outcomes:
    - action: >-
        seize the native recording from the original device, hashed at
        seizure, before the roughly 28-day retention loop overwrites it
      benefit: >-
        the court gets an original it can test, and a manipulated clip can be
        caught before it convicts an innocent person.
    - action: >-
        test the independence of every corroborating clip rather than counting
        angles that agree
      benefit: >-
        juries are protected from manufactured certainty, because a second
        camera angle is now one more prompt away.
    - action: >-
        build access to forensic experts and press for reform of the
        computer-evidence presumption
      benefit: >-
        disputed footage gets tested rather than believed or waved away,
        protecting the innocent from fakes and society from the liar's
        dividend.
---
...
<KeyNumbers
  stats={[
    { value: '8 million', label: 'deepfakes projected to circulate in 2025, up from around 500,000 in 2023', sub: 'Europol IOCTA 2025' },
    { value: 'All', label: 'of the leading AI video generators now produce synchronised audio natively', sub: 'sound is the default, not a rare feature, by mid-2026' },
...
- Content provenance — the [Coalition for Content Provenance and Authenticity (C2PA)](https://c2pa.org/) and the [Content Authenticity Initiative's state of the field](https://contentauthenticity.org/blog/the-state-of-content-authenticity-in-2026); Google [SynthID](https://deepmind.google/technologies/synthid/). On the limits of C2PA in practice, see the independent testing at [Hacker Factor, "Google Pixel 10 and Massive C2PA Failures"](https://www.hackerfactor.com/blog/index.php?/archives/1077-Google-Pixel-10-and-Massive-C2PA-Failures.html) (2026), which validated a tampered manifest as untampered against the official checker, and [Android Police on how trivially the credential itself can be stripped](https://www.androidpolice.com/pixel-10-c2pa-signature-deletion-metadata-context/).
- The 8 million/500,000 deepfake volume figures are Europol's projection, from [Europol Innovation Lab, "Facing Reality? Law Enforcement and the Challenge of Deepfakes"](https://www.europol.europa.eu/publications-events/publications/facing-reality-law-enforcement-and-challenge-of-deepfakes), reiterated in the 2025 Internet Organised Crime Threat Assessment (IOCTA). CCTV retention figures follow UK police and ICO guidance recommending a retention baseline of roughly 30 days, after which most systems overwrite on a loop; see [Clearway, "How long should I keep CCTV footage for?"](https://www.clearway.co.uk/news/how-long-should-i-keep-cctv-footage-for/).
