...
keyTakeaways:
  - '"Do you understand?" works as a ritual rather than a test, inviting a yes that keeps the system moving while failing the people who most need clarity.'
  - People hide confusion to save face, and the causes — poor literacy, neurodivergence, learning disability, distress or language barriers — are easily missed.
  - 'The better approach is "teach-back": ask the person to explain the caution, options or conditions in their own words to check the message actually landed.'
  - 'PACE and the court directions already expect understanding to be verified, so the change is cultural — make saying "no" safe and treat clarity as the officer''s responsibility.'
pubDate: 2026-01-07
author: ''
...
practicalSummary:
  problem: >-
    "Do you understand?" — asked after the caution, at booking-in and before
    a plea — works as a ritual rather than a test, inviting a yes that keeps
    the system moving while failing the people who most need clarity.
  evidence:
    - point: >-
        The Equal Treatment Bench Book warns that asking "do you understand?"
        is unreliable because people say yes to save face, and recommends
        asking the person to feed back what they have understood in their own
        words.
      source: "Equal Treatment Bench Book"
      url: "https://www.judiciary.uk/wp-content/uploads/2022/09/Equal-Treatment-Bench-Book.pdf"
    - point: >-
        PACE Code C already builds the safeguard in: the appropriate adult
        exists to facilitate communication and protect people who do not
        understand the significance of what is said to them.
      source: "PACE Code C"
      url: "https://www.gov.uk/government/publications/pace-code-c-2023/pace-code-c-2023-accessible"
    - point: >-
        The Criminal Practice Directions require courts to take every
        reasonable step to enable a defendant to comprehend and participate
        effectively.
      source: "Criminal Practice Directions (2023)"
      url: "https://www.gov.uk/guidance/criminal-procedure-rules-2025-and-criminal-practice-directions-2023"
  outcomes:
    - action: >-
        replace the checkbox question with teach-back, asking people to
        explain the caution or their conditions in their own words
      benefit: >-
        officers hear where the misunderstanding sits and fix it, and
        interviews, custody decisions and conditions rest on real
        comprehension.
    - action: >-
        make "no" safe to say and treat clarity as the officer's
        responsibility, with an explicit escalation ladder when comprehension
        fails
      benefit: >-
        the force gets fewer failed interviews, misunderstandings and
        complaints, and vulnerable people get a fairer process.
---
...
**Police officers, custody staff, lawyers and magistrates all reach for the same phrase at the same moments: after the caution, during booking-in, before a signature, before a plea, before conditions are explained. "Do you understand?" sounds like fairness, but it often works as a ritual rather than a test — a question about comprehension that shame and social pressure quietly answer for us.**

<PullQuote>“Do you understand?” sounds like fairness, but it often functions as a ritual rather than a test.</PullQuote>
...
- Judicial College, [Equal Treatment Bench Book](https://www.judiciary.uk/wp-content/uploads/2022/09/Equal-Treatment-Bench-Book.pdf) (July 2024, updated February 2026) — see the "Checking understanding" guidance, which warns that asking "do you understand?" is unreliable and recommends checking through feedback in the person's own words.
- [PACE Code C](https://www.gov.uk/government/publications/pace-code-c-2023/pace-code-c-2023-accessible) — on the role of the appropriate adult in facilitating communication and safeguarding those who do not understand the significance of what is said to them.
- [Criminal Practice Directions 2023](https://www.gov.uk/guidance/criminal-procedure-rules-2025-and-criminal-practice-directions-2023) (as amended November 2025) — the court's duty to take "every reasonable step" to enable a defendant to comprehend and participate effectively, and the Criminal Procedure Rules mechanism for appointing an intermediary.
- On "teach-back" as a comprehension check, see the healthcare and safeguarding literature where the technique originates.
