...
<figure>
  <img src="/images/football-domestic-abuse-numbers.svg" alt="Two figures from the 2014 Lancashire study: domestic abuse reports rose 26% on days England won or drew, and 38% on days England lost, compared with days England did not play. Source: Kirby, Francis and O'Flaherty, 2014, one police force across three World Cups, 2002 to 2010." loading="lazy" />
  <figcaption>The figures that launched a thousand posters — and the health warning that rarely travels with them: one force, three tournaments.</figcaption>
</figure>

Two things about that chart matter, and the second is almost always lost. The first is the 38%: abuse reports on days England lost ran more than a third above days when England did not play. The second is the 26%: abuse *also* rose on days England **won or drew**. The study found the rise on losing days was the largest, which is why "when England lose" became the sticky phrase — but the same research found a substantial rise on the good days too. The number that spreads is rarely the number that is most complete.
...
So when reports rise on a match day, an honest reader has to ask: did more abuse *happen*, or did the same amount of abuse become more *visible* — more police about, more neighbours calling, a victim seizing a moment? This is not pedantry. If a "spike" were really just a reporting artefact, the policy response would be different, and the claim would be far weaker than it sounds.

The reassuring and sobering answer is that the better studies have taken this seriously, and the pattern they find looks like real abuse, not just real reporting. Two fingerprints point that way. First, the increases concentrate in the **hours during and after the match**, not across the whole day in the diffuse way a general "more eyes about" effect would produce. Second, the rises show up in **specific categories** — intimate partners, and male-on-female abuse — while categories you would expect to move too if it were simply easier to report, such as abuse by ex-partners or female-on-male incidents, [do not move in the same way](https://fullfact.org/crime/world-cup-domestic-abuse/). A pure reporting effect should lift the whole boat. This lifts one part of it. That selectivity is the signature of a change in what is actually happening.
...
Their headline finding turns the popular story on its head. The rise was concentrated not on defeats but on **victories** — reported alcohol-related domestic abuse rose by [around 47% on the day England won](https://www.wbs.ac.uk/news/domestic-abuse-increases-almost-50-per-cent-after-england-win-at-world-cup/) a tournament match. There was a smaller rise the day after, of roughly 18%. And crucially, they found **no measurable increase in domestic abuse that was not flagged as alcohol-related.** The mechanism, in other words, does not look like the rage of a thwarted fan. It looks like alcohol — the long, celebratory, all-day drinking that a big England win licenses.
...
This is where the evidence is cleverer than you might expect. The fixtures a nation watches are, in an important sense, **randomly assigned**: which day England play, and whom, falls out of a draw of balls from a pot years earlier, with no relationship to anything about the domestic lives of the people watching. That randomness is what lets researchers treat a tournament almost like a natural experiment — closer to the gold-standard randomised trial than crime data usually gets. Analyses of the West Midlands data published through the [LSE's Centre for Economic Performance](https://blogs.lse.ac.uk/politicsandpolicy/england-football-alcohol-domestic-violence/) argue, on exactly this basis, that the link is **likely causal** rather than coincidental.

<figure>
  <img src="/images/football-domestic-abuse-timecourse.svg" alt="A schematic curve of reported alcohol-related domestic abuse across an England match day: flat through the afternoon, climbing during the three-hour match window from kick-off, peaking in the three hours after full-time, then gradually falling back to baseline. The rise tracks the game and the drinking around it." loading="lazy" />
  <figcaption>The clinching detail is the timing: the rise begins with the match, peaks in the hours after the whistle, then fades. An effect that tracks the game this closely is hard to explain as anything but the game — and the drinking around it.</figcaption>
</figure>

The clinching detail is the shape of it across the hours of the day. The increase does not sit flat across the date; it **begins during the three-hour match window, peaks in the three hours after full-time, and then declines.** A confound like "it was just a Saturday" cannot produce a curve that tracks kick-off and full-time so precisely. An effect that follows the match minute-for-minute is, to the extent observational data ever can be, the match's fingerprint.
...
The evidence says football is not magic, but it is not arbitrary either. The most recent and most granular analysis — [Ria Ivandic, Tom Kirchmaier and Neus Torres-Blas, published in the *Journal of Public Economics* in 2024](https://ideas.repec.org/p/cep/cepcnp/618.html) — finds the rise is almost entirely among perpetrators who had been drinking, and is concentrated around matches that **kick off before 7pm**: the fixtures that hand a fan a whole afternoon and evening to drink. The increase does not even peak at the final whistle. It builds for hours, cresting roughly ten hours after kick-off. That is not the profile of a man enraged by a result in the moment. It is the profile of a long day's drinking finally arriving home.

So in one sense your instinct is right: the lever is alcohol, and the occasion is in principle interchangeable. But football is not *just any* occasion — and we can show that, because not every sport does this. The same body of research finds **no comparable rise around England rugby internationals**, even though rugby is the more physically violent game on the pitch. By contrast, [Old Firm matches in Glasgow](https://journals.sagepub.com/doi/10.1177/2158244013504207) — Celtic against Rangers, a rivalry soaked in drink — *do* show large increases. The pattern is not "sport," and it is emphatically not on-field aggression bleeding into the home. It is the specific, mass, all-day drinking that a handful of football occasions convene across a whole country at once. Football matters because of the *kind of drinking it gathers* — not because there is something uniquely poisonous about the game, or about the people who love it.
...
- **The direction is solid.** Across two very different police datasets, separated by years and method, England tournament matches are associated with a real rise in domestic abuse. Two independent looks pointing the same way is what earns confidence; this has it.
- **The mechanism is alcohol, not the scoreline.** The best-identified study finds the rise is in *alcohol-related* abuse and concentrated on *wins*. The famous "when England lose" framing is the least representative version of the finding.
- **It is not "any sport," or the violence on the pitch.** England *rugby* shows no comparable rise; Glasgow's Old Firm does. What football supplies is a particular kind of mass, all-day drinking — which is also why blaming fans, rather than the drinking the occasion convenes, misreads the evidence.
- **It is plausibly causal.** The quasi-random timing of fixtures, and the way the increase tracks kick-off and full-time hour by hour, make this much stronger than a bare correlation.
- **The "38%" is narrower than its fame.** It is one real number from one force across three World Cups — a true finding doing more rhetorical work than a single-force study can bear. Lean on the *pattern*, not that one figure.
- **Every number here is a floor.** With four in five incidents never reported, the recorded spikes understate the real ones.
...
But it does not follow that the football spike fades in step, for two reasons the data insists on. First, the mechanism here is **binge drinking on an occasion**, not the weekday average. A tournament day is a spike that sits on top of ordinary life; it can survive even as the everyday baseline drops. Second, Britain's drinking is not so much declining as **polarising** — the average falls while alcohol-specific deaths have climbed to record highs, because a heavy-drinking minority is drinking harder. That minority, not the abstaining teenager, is the population the football effect runs through. So the honest position is: it *may* be easing, but no one has shown the match-day spike tracking the fall in consumption. That is an assumption, not a finding — exactly the kind this strand exists to flag.
...
But here is the one genuinely hopeful thing the data gives us, and it is the whole point of reading it carefully. A risk that is **predictable** is a risk that can be **planned for**. We know the tournaments years in advance. We know the match days the moment the draw is made. We know the hours that matter — during the game and just after — and we know alcohol is the lever. That is not a counsel of despair; it is an operational gift. It is why forces surge response and safeguarding around fixtures, why refuges and helplines staff up, why the campaigns time themselves to kick-off.

Football does not cause domestic abuse. Abusers cause domestic abuse, and they would do so if no ball were ever kicked. What a tournament does is supply the occasion and the alcohol that make an existing danger spike on a schedule we can read in advance. Reading it honestly — neither inflating it into a slogan nor explaining it away — is how we make sure the planning is aimed at the real thing.

*Explore the figures behind pieces like this in the [Crime Dashboard →](/data), and see more in [safeguarding](/topics/safeguarding) and the [More or Less Policing](/data-stories/reading-the-data) strand.*
...
- LSE Centre for Economic Performance, ["The link between England football victories and the recorded increase in alcohol-related domestic abuse is likely to be causal"](https://blogs.lse.ac.uk/politicsandpolicy/england-football-alcohol-domestic-violence/) — the causal argument and the hourly time-course.
- Ria Ivandic, Tom Kirchmaier & Neus Torres-Blas, ["Football, alcohol, and domestic abuse"](https://ideas.repec.org/p/cep/cepcnp/618.html), *Journal of Public Economics*, 2024 — the most granular analysis: increases driven almost entirely by perpetrators who had been drinking, concentrated on matches kicking off before 7pm, peaking around ten hours after kick-off.
- ["Major sports events and domestic violence: a systematic review"](https://pmc.ncbi.nlm.nih.gov/articles/PMC10087409/) — a review across sports and countries, including the absence of a comparable effect around England rugby; and Williams et al., ["Old Firm football matches and reported domestic (violence) incidents in Strathclyde"](https://journals.sagepub.com/doi/10.1177/2158244013504207), 2013.
- Alcohol Change UK, ["Drinking trends in the UK"](https://alcoholchange.org.uk/alcohol-facts/fact-sheets/drinking-trends-in-the-uk) — the long decline in average consumption alongside the polarisation of heavy drinking.
- Full Fact, ["World Cup: does domestic abuse spike when England lose?"](https://fullfact.org/crime/world-cup-domestic-abuse/) — a careful fact-check, the reporting-versus-incidence question, and under-reporting figures.
- Women's Aid, ["No More Years of Hurt"](https://womensaid.org.uk/womens-aid-launches-no-more-years-of-hurt-campaign-highlighting-the-spike-in-domestic-abuse-during-big-football-games/) — campaign context around major tournaments.
- BBC News and PA, on tournament-linked [domestic abuse reports](https://feeds.bbci.co.uk/news/articles/cdd7qzd1nmvo) and [999 calls during Euro 2024](https://www.aol.com/999-calls-domestic-abuse-england-074147387.html).
