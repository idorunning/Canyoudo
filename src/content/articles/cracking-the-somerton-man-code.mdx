...
{/* VIDEO PLACEHOLDER — the explainer video goes here. Replace this comment with the embed (e.g. <iframe …>) or a self-hosted <video …> once the file is ready. */}
...
<figure>
  ...
  <figcaption><em>Tamám Shud</em> — "it is ended" — the scrap torn from the final page of the <em>Rubáiyát</em> and found hidden in the dead man's pocket.</figcaption>
</figure>
...
<figure>
  <img src="/images/somerton-man-code.jpg" alt="The five lines of capital letters preserved as indentations in the Rubáiyát" loading="lazy" />
  <figcaption>The five lines of capital letters, recovered from faint indentations pressed into a page of the <em>Rubáiyát</em>. For decades they were assumed to be a cipher.</figcaption>
</figure>
...
| **Line 5: ITTMTSAMSTGAB** | **102 km** | **8.5 km** | Ends G–A–B, the final triangle |
...
<figure>
  <img src="/images/somerton-ai-cctv-knife.png" alt="A grainy green night-vision image of a man holding a knife" loading="lazy" />
  <figcaption><strong>An AI-generated illustration, not real footage or evidence.</strong> For decades the Somerton Man was imagined like this — a spy, a cipher, a threat — the sinister reading the evidence never quite supported.</figcaption>
</figure>

<figure>
  <img src="/images/somerton-ai-cctv-flowers.jpg" alt="A grainy green night-vision image of a man holding a bunch of flowers" loading="lazy" />
  <figcaption><strong>An AI-generated illustration, not real footage or evidence.</strong> The likelier man: not an agent with a knife but someone carrying flowers across a city, looking for a person he had lost.</figcaption>
</figure>
