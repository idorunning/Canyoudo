...
keyTakeaways:
  - AI predicts patterns at scale rather than understanding anything, which explains both its strengths and its failures.
  - 'A model is only as good and as unbiased as its training data, and it cannot truly explain itself, so "the computer flagged him" is never a lawful basis for a decision.'
  - 'Anything typed into a public AI tool may leave the building for good: treat it like a postcard, not a sealed envelope, and insist on a DPIA and data-residency terms.'
  - 'The practical rule is to use AI to narrow, draft and prioritise but never to decide, with a trained human who is willing and able to overturn the output.'
pubDate: 2026-06-15
author: ''
thumbnail: /images/11548.webp
heroImage: /images/11548.webp
tags:
...
practicalSummary:
  problem: >-
    Police leaders are asked to approve, govern and publicly defend AI tools
    they were never trained to understand — and the accountability for what
    those tools do cannot be delegated to the supplier.
  evidence:
    - point: >-
        AI predicts rather than understands, so it produces confident, fluent,
        wrong answers — and a model trained on historic policing data
        reproduces historic disproportionality with an air of mathematical
        objectivity.
    - point: >-
        Samsung staff pasted confidential material into a public chatbot three
        times in 2023 and it left the company for good — what goes into a free
        AI tool may be stored abroad and used to train future models.
      source: "Samsung leaks (2023)"
    - point: >-
        Using AI lawfully with personal data requires a Data Protection Impact
        Assessment and negotiated data-residency terms; the ICO's guidance is
        the authoritative UK reference.
      source: "Information Commissioner's Office"
      url: "https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/artificial-intelligence/"
  outcomes:
    - action: >-
        use AI to narrow, draft and prioritise but never to decide, keeping a
        trained human able to overturn the output
      benefit: >-
        the force gets the speed of AI on high-volume work without
        indefensible decisions reaching the public.
    - action: >-
        complete a DPIA and negotiate data-residency, retention and
        no-training terms before any tool is deployed
      benefit: >-
        the force's data stays under contract rather than leaking for good,
        and leaders can defend the tool at a scrutiny panel.
    - action: >-
        brief every officer to treat a public AI tool like a postcard, not a
        sealed envelope
      benefit: >-
        sensitive material such as a victim's account never leaves the
        building unrecoverably.
---
...
<PullQuote>It predicts, it does not comprehend — and that single fact explains almost every strength and every failure in this guide.</PullQuote>
