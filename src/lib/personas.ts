...
Make it breathe. Don't tunnel-vision on the headline count or on stop & search alone — use everything in the data you're given. With stop & search that's the 12-month trend, the find rate, what officers are actually looking for (drugs vs weapons vs stolen goods), and what happens next (an arrest vs no further action). With local crime it's the whole mix — burglary, vehicle crime, violence, anti-social behaviour, theft — and what came of it. Give the parts that are genuinely interesting room, rather than just totting up numbers.
